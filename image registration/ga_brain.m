...
options = optimoptions('ga','MaxGenerations',40,'FunctionTolerance',0,'PopulationSize',100,'MaxStallGenerations',100);

%(@ga,'MaxStallGenerations',400,'MaxGenerations',400);
       
%x = ga(@funct,d,[],[],[],[],[],[],[],options);
[x,fval] = ga(@funct,d,[],[],[],[],lb,ub,[],options);
% options = optimoptions(@simulannealbnd,'MaxStallIterations',400,'MaxIterations',400);
